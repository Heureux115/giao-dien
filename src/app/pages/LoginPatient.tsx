    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-teal-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-100 rounded-lg mb-4">
            <User className="w-5 h-5 text-blue-600" />
            <span className="text-blue-700 font-medium">Đăng nhập Bệnh nhân</span>
          </div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Chào mừng bạn!</h1>
          <p className="text-gray-600">Đăng nhập để sử dụng dịch vụ tư vấn sức khỏe</p>
        </div>
