...
export default function LoginAISpecialist() {
      ...
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-purple-100 rounded-lg mb-4">
            ...
            <span className="text-purple-700 font-medium">Chuyên gia AI</span>
          </div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Chào mừng Chuyên gia!</h1>
          <p className="text-gray-600">Đăng nhập để quản lý và cải thiện AI</p>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="specialist@healthcare.com"
